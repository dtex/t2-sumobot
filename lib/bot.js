...
board.on("ready", function() {
  ...
  var left = new Five.Servo({ pin: "a5", type: "continuous", invert: true });
  var right = new Five.Servo({ pin: "a6", type: "continuous" });
  ...
  bot.left = function() { right.ccw(1);left.cw(1); };
  bot.right = function() { right.cw(1);left.ccw(1); };
